...
## Project Structure
    ...
    ├── testapiautoconnecto_89255  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_89255`
...
2. Clone this repo and `cd testapiautoconnecto_89255`
